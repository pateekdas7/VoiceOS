...
def test_unassigned_number_is_rejected() -> None:
    ...
    assert TelephonyNumberResolver(conn).resolve_for_call("+919900000099", direction="outbound-api") is None
...
def test_direction_controls_capability_column() -> None:
    ...
    TelephonyNumberResolver(conn).resolve_for_call("+919900000001", direction="outbound-api")
